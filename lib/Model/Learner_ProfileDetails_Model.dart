...
LearnerProfileDetails profileDetailsFromJson(String str) => LearnerProfileDetails.fromJson(json.decode(str));

String profileDetailsToJson(LearnerProfileDetails data) => json.encode(data.toJson());
