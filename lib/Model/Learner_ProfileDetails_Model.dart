...
LearnerProfileDetails profileDetailsFromJson(String str) =>
    LearnerProfileDetails.fromJson(json.decode(str));

String profileDetailsToJson(LearnerProfileDetails data) =>
...
class LearnerProfileDetails {
  ...
  factory LearnerProfileDetails.fromJson(Map<String, dynamic> json) =>
      LearnerProfileDetails(
        status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        interestedCategory: json["interested_category"] != []
            ? List<InterestedCategory>.from(json["interested_category"]
                .map((x) => InterestedCategory.fromJson(x)))
            : null,
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "educational_details":
            List<dynamic>.from(educationalDetails1!.map((x) => x.toJson())),
        ...
        "isNew": isNew,
        "interested_category":
            List<dynamic>.from(interestedCategory!.map((x) => x.toJson())),
      };
...
class InterestedCategory {
  ...
  factory InterestedCategory.fromJson(Map<String, dynamic> json) =>
      InterestedCategory(
        key: json["key"],
        value: json["value"],
