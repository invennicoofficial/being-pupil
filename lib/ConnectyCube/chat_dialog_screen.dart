...
import 'package:being_pupil/ConnectyCube/full_photo.dart';
...
class ChatDialogScreen extends StatelessWidget {
  ...
  ChatDialogScreen(this._cubeUser, this._cubeDialog, this.imageUrl);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          ChatScreen(this._cubeUser, _cubeDialog),
        ],
      ),
    );
  }
              ...
              message.attachments?.isNotEmpty ?? false
                  ...
                  ? Container(
                      child: TextButton(
                        ...
                        onPressed: () {
                          pushNewScreen(context, screen: FullPhoto(
